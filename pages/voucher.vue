        ...
        <div class="tambah-category">
          ...
          >
            ...
            <div class="d-block text-center">
              <h1 class="judul_modal mt-2">Add Voucher</h1>
            </div>
            <form
                ...
                <tr>
                  ...
                  <td class="text-center">
                    ...
                    >
                      ...
                      <div class="d-block text-center">
                        <h1 class="judul_modal mt-2">Edit Voucher</h1>
                      </div>
                      <form
                        class="form_modal pt-4 pb-2 px-2"
                        @submit.stop.prevent="onSubmit"
                  ...
                  <td class="text-center">
                    ...
                    >
                      ...
                      <div class="d-block text-center">
                        <h1 class="judul_modal mt-2">Delete Voucher</h1>
                      </div>
                      <form
                        class="form_modal pt-4 pb-2 px-2"
                        @submit.stop.prevent="onSubmit"
                      >
                        <div class="row">
                          <div class="col-12 mb-4">
                            <p>Apakah Anda yakin ingin menghapus voucher?</p>
                          </div>
                        </div>
  ...
  methods: {
    async onSubmit() {
      ...
      if (!this.$v.form.$invalid) {
        this.isLoading = true
        try {
          const resp = await this.$axios.$post('/api/voucher', this.form, {

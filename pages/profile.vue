        ...
        <div class="tambah-profile">
          ...
          >
            ...
            <div class="d-block text-center">
              <h1 class="judul_tambah_alamat mt-2">Add Profile</h1>
            </div>
            <form
              ...
              <div class="row">
                ...
                <div class="col-12">
                  ...
                  <Field
                    ...
                    type="text"
                    placeholder="p / l"
                    :value="$v.form.gender.$model"
                    :error="$v.form.gender.$dirty && $v.form.gender.$error"
                    @model="$v.form.gender.$model = $event"
                  />
                </div>
                <div class="col-12">
                  <label for="phone" class="label_modal col-12 mb-1 pt-2"
                    >Phone</label
                  >
                  <Field
                ...
                <div class="col-12">
                  <label for="role" class="label_modal col-12 mb-1 pt-2"
                    >Role</label
                  >
                  <Field
                    ...
                    :value="$v.form.role.$model"
                    :error="$v.form.role.$dirty && $v.form.role.$error"
                    @model="$v.form.role.$model = $event"
                  />
                </div>
                <div class="col-12">
                  <label for="birthday" class="label_modal col-12 mb-1 pt-2"
                    >Birthday</label
                  >
                  <Field
                    class="col-12 mb-4 field_input"
                    type="date"
                    placeholder=""
                    :value="$v.form.birthday.$model"
                    :error="$v.form.birthday.$dirty && $v.form.birthday.$error"
                    @model="$v.form.birthday.$model = $event"
                  />
                </div>
              </div>
                ...
                <tr>
                  ...
                  <td class="text-center">
                    ...
                    >
                      ...
                      <div class="d-block text-center">
                        <h1 class="judul_tambah_alamat mt-2">Edit Profile</h1>
                      </div>
                      <form
                        class="form_modal pt-4 pb-2 px-2"
                        @submit.stop.prevent="onSubmit"
                        ...
                        <div class="row">
                          ...
                          <div class="col-12">
                            ...
                            <Field
                              ...
                              :value="$v.form.gender.$model"
                              :error="
                                $v.form.gender.$dirty && $v.form.gender.$error
                              "
                              @model="$v.form.gender.$model = $event"
                            />
                          </div>
                          ...
                          <div class="col-12">
                            ...
                            <Field
                              ...
                              :value="$v.form.role.$model"
                              :error="
                                $v.form.role.$dirty && $v.form.role.$error
                              "
                              @model="$v.form.role.$model = $event"
                            />
                          </div>
                  ...
                  <td class="text-center">
                    ...
                    >
                      ...
                      <div class="d-block text-center">
                        <h1 class="judul_tambah_alamat mt-2">Delete Profile</h1>
                      </div>
                      <form
                        class="form_modal pt-4 pb-2 px-2"
                        @submit.stop.prevent="onSubmit"
                      >
                        <div class="row">
                          <div class="col-12 mb-4">
                            <p>Apakah Anda yakin ingin menghapus profile?</p>
                          </div>
                        </div>
  ...
  methods: {
    async onSubmit() {
      ...
      if (!this.$v.form.$invalid) {
        this.isLoading = true
        try {
          const resp = await this.$axios.$post('/api/profile/get', this.form, {

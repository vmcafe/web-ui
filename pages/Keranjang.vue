    ...
    <b-container class="keranjang__utama">
      <b-row>
        <b-col md="6" sm="12">
          ...
          <div>
            <b-card
              class="product_belanja"
              v-for="item_2 in [1, 2, 3]"
              :key="item_2"
            >
              <b-row>
                <b-col>
                ...
                <b-col class="tas_product">
                  ...
                  <b-row>
                    ...
                    <div class="counter">
                      ...
                      <div class="counter__content">{{ count }}</div>
              ...
              <div class="kode__diskon">
                <b-row>
                  ...
                  <b-col cols="8">
                    <b-input-group>
                      <b-form-input
                        class="input_kode_diskon"
                        id="form-input-kode-promo"
                        size="lg"
                        placeholder="Masukan kode promo"
                        >{{ kode }}</b-form-input
                      >
                      <b-input-group-append class="button__terapkan">
                        <b-button
                          class="button_kode_diskon"
                          text="Button"
                          size="lg"
                          variant="secondary"
                          >Terapkan</b-button

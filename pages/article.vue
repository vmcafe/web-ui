        ...
        <div class="tambah-article">
          ...
          >
            ...
            <div class="d-block text-center">
              <h1 class="judul_tambah mt-2">Add Article</h1>
            </div>
            <form
            ...
            >
              <div class="row">
                ...
                <div class="col-12">
                  <label for="link" class="label_modal col-12 mb-1 pt-2"
                    >Link</label
                  >
                  <Field
                    ...
                    type="text"
                    placeholder=""
                    :value="$v.form.link.$model"
                    :error="$v.form.link.$dirty && $v.form.link.$error"
                    @model="$v.form.link.$model = $event"
                  />
                </div>
                <div class="col-12">
                ...
                <tr>
                  ...
                  <td class="text-center">
                    ...
                    >
                      ...
                      <div class="d-block text-center">
                        <h1 class="judul_tambah mt-2">Edit Article</h1>
                      </div>
                      <form
                        class="form_modal pt-4 pb-2 px-2"
                        @submit.stop.prevent="onSubmit"
                        ...
                        <div class="row">
                          ...
                          <div class="col-12">
                            ...
                            <Field
                              ...
                              :value="$v.form.link.$model"
                              :error="
                                $v.form.link.$dirty && $v.form.link.$error
                              "
                              @model="$v.form.link.$model = $event"
                            />
                          </div>
                  ...
                  <td class="text-center">
                    ...
                    >
                      ...
                      <div class="d-block text-center">
                        <h1 class="judul_tambah mt-2">Delete Article</h1>
                      </div>
                      <form
                        class="form_modal pt-4 pb-2 px-2"
                        @submit.stop.prevent="onSubmit"
                      >
                        <div class="row">
                          <div class="col-12 mb-4">
                            <p>Apakah Anda yakin ingin menghapus article?</p>
                          </div>
                        </div>
  ...
  methods: {
    async onSubmit() {
      ...
      if (!this.$v.form.$invalid) {
        this.isLoading = true
        try {
          const resp = await this.$axios.$post('/api/article', this.form, {
